...
gulp.task('js', () => {
    return gulp.src('client/{app,components}/**/!(*.spec|*.mock).js')
        .pipe(gulp.dest('.tmp'));
});
...
gulp.task('build:client', ['styles', 'html', 'js', 'build:images'], () => {
...
gulp.task('copy:server', () => {
	return gulp.src(_.union(paths.server.scripts, paths.server.json, paths.server.config))
